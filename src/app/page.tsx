...
export default function Home() {
  return (
    <main className="flex flex-col gap-[32px] row-start-2 items-center pt-23 px-32 pb-10 lg:pb-32">
      <Image src="/assets/mars.png" alt="Mars" priority className="absolute w-30 md:w-60 lg:w-90 xl:w-120 2xl:w-150 -left-20 md:-left-40 lg:-left-50 top-60" width={600} height={600} quality={100}/>
      <Image src="/assets/earth.png" alt="Earth" priority className="absolute w-30 md:w-60 lg:w-90 xl:w-120 2xl:w-150 -right-20 md:-right-40 lg:-right-50 top-20" width={600} height={600} quality={100}/>
