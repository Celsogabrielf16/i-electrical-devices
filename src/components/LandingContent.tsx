...
const LandingContent = () => {
    return (
        <main className="grid grid-row-[1fr_1fr] gap-[32px] row-start-2 items-center sm:items-start pt-23 px-32 pb-32">
            ...
            <div className="flex flex-col mt-32 text-center gap-8">
                ...
                <Link href="/" className="bg-indigo-500 w-fit py-4 px-8 rounded-3xl text-white font-light mx-auto">Cadastre um endereço marciano</Link>
            </div>
